...
@section('main')<div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                <h2 class="section-title">Data Analisa</h2>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($kriteria as $data)
                                                <tr>
                                                    ...
                                                    <td>{{ $data['mutu'] }}</td>
                                                    <td colspan="2">
                                                        <button type="button" class="btn btn-warning btn-sm" id="modal-kriteria-ubah" data-toggle="modal" data-target="#exampleModal" onclick="fungsiEdit('{{'modal-kriteria-ubah'}}|{{ $data['id'] }}|{{ $data['warna'] }}|{{ $data['bau'] }}|{{ $data['butir'] }}|{{ $data['hama'] }}|{{ $data['mutu'] }}|')" >
                                                        Ubah
                                                        </button>
        
                                                        <form action="{{ url('kriteria/' . $data['id']) }}" class="d-inline"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
        ...
        <form class="modal-part"
            id="modal-kriteria-part" action="{{ url('kriteria') }}" method="POST">
            @csrf
